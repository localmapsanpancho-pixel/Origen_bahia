(function () {
  ...
  var CSS = ""
    ...
    + ".cp-add-btn.btn-agregar{background:#5a7c47;color:#fff;border:none;border-radius:8px;padding:.42rem .9rem;font-size:.82rem;font-weight:700;cursor:pointer;transition:background .15s;white-space:nowrap;}"
    + ".cp-add-btn.btn-agregar:hover{background:#4a6a3a;}"
